 <meta name="description" content="Reimage Repair contact Us">
    <meta name="author" content="">
    <title>Remaige Repair Contact Us</title>
  ...
  <li><a class="btn btn-warning btn-lg" href="download.php" role="button">Start my SCAN</a></li>
   ...
   <section  class="intro-section">
    ...
    <div class="row">
        ...
        <h2>About Reimage Repair</h2>



<br>
<p>Remaige Repair Software is developed by professionals to provide you the complete solution. Reimage Repair software is able to manage your all problems related to windows for example it boost up the speed of system, virus problem, registry files problem can be solved easily.</p><br>

	  <p>With easy to use interface and installation methods you will be able to use our software easily. You can read <A HREF="user-guide.php">user Guide</A> about how to use the software.</p><br>

	  <p>In case of any query <A HREF="contact-us.php">contact us</A></p><br>

	  <p>For any kind of support related to software or general mail us at : <a href="mailto:updarequ@gmail.com">updarequ@gmail.com</a></p>
