 <meta name="description" content="Reimage Repair  disclaimer">
    <meta name="author" content="">
    <title>Reimage Repair  disclaimer</title>
  ...
  <li><a class="btn btn-warning btn-lg" href="download.php" role="button">Start my SCAN</a></li>
   ...
   <section  class="intro-section">
    ...
    <div class="row">
        ...
        <h4 class="sky_blue">Reimage Repair Now!!</h4>
        <br />
      
 <div align="justify">INFORMATION AVAILABLE ON THIS SITE IS AVAILABLE FREE, FOR SERVING PUBLIC, WITHOUT ANY EXPRESS OR IMPLIED WARRANTIES OF ANY KIND, AND THESE ARE SUBJECT TO THE FOLLOWING DISCLAIMERS: </div>
</p>

<div align="justify">The website does not guarantee the completeness and/or accuracy of materials present on the site and make no promises of updating or changing the present information.</div>
</p>

<div align="justify">The website doesn't disclaim any warranty in providing any public material, graphics, information contained on the site. The user is at their own risk to verify all material and information present on the site.</div>
</p>

<div align="justify">The web site may contain links to other website not owned or controlled by this web site. Any sponsored links, external links; materials are not controlled or approved by this web site. This web site provides information for public services.</div>
</p>

<div align="justify">This site has made all the information available for the public. So no one can distribute or copy the content or material provide on the site. However this site doesn't disclaim that material here are free of copyright claims.</div>
</p>

<div align="justify">Neither this website will be liable for any damages that may arise from viewing, distributing or copying materials on its website.</div>
</p>
